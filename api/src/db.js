...
const { Receta,TipoDeDieta  } = sequelize.models;

// Aca vendrian las relaciones

Receta.belongsToMany(TipoDeDieta, { through: 'RecetaTipoDeDieta' });
TipoDeDieta.belongsToMany(Receta, { through: 'RecetaTipoDeDieta' });
